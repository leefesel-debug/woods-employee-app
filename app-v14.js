...
function switchView(view){
 const allergenActive=view==='allergen',handbookActive=view==='handbook',bookingsActive=view==='bookings';
 $('#allergenView').hidden=!allergenActive;$('#handbookView').hidden=!handbookActive;$('#bookingsView').hidden=!bookingsActive;
 $('#allergenTab').classList.toggle('active',allergenActive);$('#handbookTab').classList.toggle('active',handbookActive);$('#bookingsTab').classList.toggle('active',bookingsActive);
 if(handbookActive)renderHandbook();if(bookingsActive)loadBookings();
...
$('#allergenTab').onclick=()=>switchView('allergen');$('#handbookTab').onclick=()=>switchView('handbook');$('#bookingsTab').onclick=()=>switchView('bookings');
